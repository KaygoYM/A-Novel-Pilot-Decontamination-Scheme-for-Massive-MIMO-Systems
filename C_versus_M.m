...
semilogx(M_test, UL_R_CS_MF, 'bo-', 'Linewidth', lw);
hold on;
semilogx(M_test, UL_R_CSsoft_MF, 'k>-', 'Linewidth', lw);
hold on;
semilogx(M_test, UL_R_WGCPA_MF, 'r^-', 'Linewidth', lw);
hold on;
%semilogx(M_test, UL_R_WGCPAIM_MF, 'mx-', 'Linewidth', lw);
%hold on;
semilogx(M_test, UL_R_WGCPAsoft_MF, 'cs-', 'Linewidth', lw);
hold on;
