...
%         end
    ...
    %    DL_SINR_WGCPAsoft_MF(:,:,i_test) = F_DLSINR_CAL(L, K, M, H, P1, rho_pilot, rho_dl, 2);
...
% figure; 
% 
% y = 10*log10(reshape(DL_SINR_CS_MF,1,L*K*Test_num));
% ymin=min(y); 
% ymax=max(y); 
% x=linspace(ymin,ymax,Tau); 
% yy=hist(y,x);
...
% hold on;
% 
% y = 10*log10(reshape(DL_SINR_CSsoft_MF,1,L*K*Test_num));
% ymin=min(y); 
% ymax=max(y); 
% x=linspace(ymin,ymax,Tau); 
% yy=hist(y,x);
...
% hold on;
% 
% y = 10*log10(reshape(DL_SINR_WGCPA_MF,1,L*K*Test_num));
% ymin=min(y); 
% ymax=max(y); 
% x=linspace(ymin,ymax,Tau); 
% yy=hist(y,x);
...
% hold on;
% 
% y = 10*log10(reshape(DL_SINR_WGCPAsoft_MF,1,L*K*Test_num));
% ymin=min(y); 
% ymax=max(y); 
% x=linspace(ymin,ymax,Tau); 
% yy=hist(y,x);
...
% 
% 
% y = 10*log10(reshape(DL_SINR_GCPA_MF,1,L*K*Test_num));
% ymin=min(y); 
% ymax=max(y); 
% x=linspace(ymin,ymax,Tau); 
% yy=hist(y,x);
