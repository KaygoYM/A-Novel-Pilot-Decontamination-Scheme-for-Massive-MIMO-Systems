function [P_output eu] = F_WGCPA_soft_Pilot(L, K, S, Beta,lambda)
...
%             for j1_bs = 1:L
%                 for k1_user = 1:K
%                     if j_bs~=j1_bs && eta(j_bs,k_user,j1_bs,k1_user)>eta_max && P(j_bs,k_user)~=-1 && P(j1_bs,k1_user)~=-1
%                         j_0 = j_bs;
%                         k_0 = k_user;
%                         j_1 = j1_bs;
%                         k_1 = k1_user;
